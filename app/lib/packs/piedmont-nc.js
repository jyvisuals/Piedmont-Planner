...
export const PIEDMONT_NC = {
    schemaVersion: 1,
    id: "piedmont-nc",
    name: "North Carolina Piedmont",
    description: "Hand-reviewed override for the NC Piedmont (Carrboro reference point, on the 7b/8a line). Sample rows demonstrating verbatim and anchored timing; the full pack is derived from data.js by the legacy loader.",
    ...
    crops: [
        ...
        // -------------------------------------------------------------------
        {
            ...
            varieties: "Cherokee Purple (heirloom, needs airflow — prone to cat-facing/cracking), Celebrity Plus, Mountain Magic/Fresh and Mountain Girl (disease-resilient for humid late-summer Piedmont). Grafting onto RST/DRO rootstock extends the season; keep the graft union above soil.",
