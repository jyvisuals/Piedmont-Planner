...
export const CROP_CATALOG = {
    ...
    "onions-green": {
        ...
        daysToMaturity: {
            direct: [60, 70],
            note: 'Planted from sets ("B" in the legacy grid). Legacy lists a second unlabeled range, 42-56; the first range is kept as primary and treated as direct (assumption).',
        },
    },
    spinach: {
        slug: "spinach",
    ...
    "onions-bulb": {
        ...
        daysToMaturity: {
            direct: [90, 120],
            note: "Single legacy range; the legacy grid shows both direct sowing and transplanting — assigned to direct sow (assumption).",
        },
    },
    leek: {
        slug: "leek",
    ...
    kale: {
        ...
        daysToMaturity: {
            direct: [14, 22],
            note: "Legacy lists two unlabeled ranges (14-22, 40-50); the first is kept as primary on the dominant direct-sow method (assumption — plausibly a baby-leaf cut), the second preserved here: 40-50.",
        },
    },
    "collard-greens": {
        slug: "collard-greens",
    ...
    "chard-swiss": {
        ...
        daysToMaturity: {
            direct: [60, 70],
            note: "Legacy lists two unlabeled ranges (60-70, 32-42); the first is kept as primary on the dominant direct-sow method, the second preserved here: 32-42 (plausibly from transplant).",
        },
        minFrostFreeDays: 70,
    },
    carrots: {
    ...
    garlic: {
        ...
        daysToMaturity: {
            direct: [180, 210],
            note: 'Legacy "B = 180-210": days from planting cloves in fall. Overwinters; harvested early-mid summer the following year.',
        },
    },
    "beans-snap-bush": {
